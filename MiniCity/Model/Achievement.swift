...
enum Achievements {
    ...
    static let all: [Achievement] = [
        ...
        Achievement(id: "pop.100", group: .population, title: "はじめの一歩",
                    detail: "人口 100 人", symbol: "figure.walk") { $0.sim.residents >= 100 },

        Achievement(id: "pop.1000", group: .population, title: "町になった",
                    detail: "人口 1,000 人", symbol: "house.fill") { $0.sim.residents >= 1_000 },

        Achievement(id: "pop.5000", group: .population, title: "市になった",
                    detail: "人口 5,000 人", symbol: "building.2.fill") { $0.sim.residents >= 5_000 },

        Achievement(id: "pop.10000", group: .population, title: "大都市",
                    detail: "人口 10,000 人", symbol: "building.columns.fill") { $0.sim.residents >= 10_000 },

        Achievement(id: "pop.20000", group: .population, title: "首府",
                    detail: "人口 20,000 人", symbol: "crown.fill") { $0.sim.residents >= 20_000 },
        ...
        Achievement(id: "industrial.city", group: .population, title: "工都",
                    detail: "工業の雇用 3,000", symbol: "gearshape.fill") {
        ...
        Achievement(id: "no.blackout", group: .planning, title: "灯を絶やさない",
                    detail: "停電ゼロのまま人口 5,000 人", symbol: "bolt.fill") {
        ...
        Achievement(id: "services", group: .planning, title: "備えあり",
                    detail: "警察署と消防署を 5 つずつ", symbol: "cross.case.fill") {
        ...
        Achievement(id: "year.1950", group: .time, title: "半世紀",
                    detail: "1950 年まで街を保つ", symbol: "clock.fill") { $0.sim.year >= 1950 },

        Achievement(id: "year.2000", group: .time, title: "世紀を越えて",
                    detail: "2000 年まで街を保つ", symbol: "hourglass") { $0.sim.year >= 2000 },

        Achievement(id: "year.2100", group: .time, title: "次の百年",
                    detail: "2100 年まで街を保つ", symbol: "infinity") { $0.sim.year >= 2100 },
    ]
